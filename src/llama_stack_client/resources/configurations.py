...
from ..types import config_register_params
from .._base_client import make_request_options
from ..types.configuration_inspect_response import ConfigurationInspectResponse
from ..types.configuration_register_response import ConfigurationRegisterResponse
...
class ConfigurationsResource(SyncAPIResource):
    ...
    ) -> ConfigurationInspectResponse:
        return self._get(
            "/v1/inspect/configurations",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                post_parser=DataWrapper[ConfigurationInspectResponse]._unwrapper,
            ),
            cast_to=cast(Type[ConfigurationInspectResponse], DataWrapper[ConfigurationInspectResponse]),
        )
    ...
    def register(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = NOT_GIVEN,
    ) -> ConfigurationRegisterResponse:
        return self._post(
            "/v1/configurations/register",
            body=maybe_transform(
                {
                    "config": config,
                },
              config_register_params.ConfigRegisterParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout,
            ),
            cast_to=ConfigurationRegisterResponse
        )
